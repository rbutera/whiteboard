...
- `@whtbrd/core` — authoring: element shapes, host-schema kit, Zod → wire validation
- `@whtbrd/server` — reference board service: event log, projections; embeddable in-process with pluggable persistence
