...
- [x] 7.5 Final clean `pnpm check`, commit, push, verify `origin/a6-python-twins` == HEAD (the PR branch; this change merges via PR #8, not by pushing `main`), output `<promise>A6-COMPLETE</promise>`.
