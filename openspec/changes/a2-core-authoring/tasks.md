...
- [ ] 1.1 Add `zod` to `@whtbrd/core` (runtime dependency, current stable major). `pnpm check` stays green.
...
- [ ] 1.6 Re-export everything from `src/index.ts` alongside `PROTOCOL_VERSION`. Commit.
